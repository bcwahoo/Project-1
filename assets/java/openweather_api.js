function callOpenWeather(destCity) {
    ...
    $.ajax({
        ...
        .then(function (response) {
            ...
            weatherP.append("<br/>" + (response.list[0].dt_txt).substr(5, 2) + "/" + (response.list[16].dt_txt).substr(8, 2) + ":  " + (parseInt((response.list[16].main.temp_max - 273.15) * 1.8) + 32) + "F     " + response.list[16].weather[0].main + "<img src='http://openweathermap.org/img/wn/" + response.list[16].weather[0].icon + "@2x.png' width='50' height='50'>");
            weatherP.append("<br/>" + (response.list[0].dt_txt).substr(5, 2) + "/" + (response.list[24].dt_txt).substr(8, 2) + ":  " + (parseInt((response.list[24].main.temp_max - 273.15) * 1.8) + 32) + "F     " + response.list[24].weather[0].main + "<img src='http://openweathermap.org/img/wn/" + response.list[24].weather[0].icon + "@2x.png' width='50' height='50'>");
            weatherP.append("<br/>" + (response.list[0].dt_txt).substr(5, 2) + "/" + (response.list[32].dt_txt).substr(8, 2) + ":  " + (parseInt((response.list[32].main.temp_max - 273.15) * 1.8) + 32) + "F     " + response.list[32].weather[0].main + "<img src='http://openweathermap.org/img/wn/" + response.list[32].weather[0].icon + "@2x.png' width='50' height='50'>");
